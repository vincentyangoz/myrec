...
!b.os.opera?"3d(":"(";b.feat.cssTransformEnd=!b.os.opera?",0)":")";b.os.android&&!b.os.webkit&&(b.os.android=!1)}function f(b){return b._afmid||(b._afmid=N++)}function e(c,a,u,d){a=b(a);if(a.ns)var h=RegExp("(?:^| )"+a.ns.replace(" "," .* ?")+"(?: |$)");return(x[f(c)]||[]).filter(function(b){return b&&(!a.e||b.e==a.e)&&(!a.ns||h.test(b.ns))&&(!u||b.fn==u||"function"===typeof b.fn&&"function"===typeof u&&b.fn===u)&&(!d||b.sel==d)})}function b(b){b=(""+b).split(".");return{e:b[0],ns:b.slice(1).sort().join(" ")}}
function h(b,c,a){m.isObject(b)?m.each(b,a):b.split(/\s/).forEach(function(b){a(b,c)})}function s(c,a,u,d,e){var s=f(c),g=x[s]||(x[s]=[]);h(a,u,function(a,u){var w=e&&e(u,a),h=w||u,f=function(b){var a=h.apply(c,[b].concat(b.data));!1===a&&b.preventDefault();return a},w=m.extend(b(a),{fn:u,proxy:f,sel:d,del:w,i:g.length});g.push(w);c.addEventListener(w.e,f,!1)})}function F(b,c,a,d){var s=f(b);h(c||"",a,function(c,a){e(b,c,a,d).forEach(function(c){delete x[s][c.i];b.removeEventListener(c.e,c.proxy,
!1)})})}function O(b){var c=m.extend({originalEvent:b},b);m.each(P,function(a,d){c[a]=function(){this[d]=Q;if("stopImmediatePropagation"==a||"stopPropagation"==a)if(b.cancelBubble=!0,!b[a])return;return b[a].apply(b,arguments)};c[d]=R});return c}function D(b,c,a,d,h){s(b,c,a,d,function(c){return function(a){var u,w=m(a.target).closest(d,b).get(0);if(w)return u=m.extend(O(a),{currentTarget:w,liveFired:b,delegateTarget:b,data:h}),c.apply(w,[u].concat([].slice.call(arguments,1)))}})}function E(b,c){if(c&&
b.dispatchEvent){var a=m.Event("destroy",{bubbles:!1});b.dispatchEvent(a)}if((a=f(b))&&x[a]){for(var d in x[a])b.removeEventListener(x[a][d].e,x[a][d].proxy,!1);delete x[a]}}function z(b,c){if(b){var a=b.childNodes;if(a&&0<a.length)for(var d;d<a.length;d++)z(a[d],c);E(b,c)}}var p,t=c.document,A=[],I=A.slice,G={},S=1,T=/<(\w+)[^>]*>/,y={},B={},J={columncount:!0,fontweight:!0,lineheight:!0,"column-count":!0,"font-weight":!0,"line-height":!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,"z-index":!0,zoom:!0},
C="object"===typeof MSApp,v=function(b,c){this.length=0;if(b){if(b instanceof v&&c==p)return b;if(af.isFunction(b))return af(t).ready(b);if(af.isArray(b)&&b.length!=p){for(var a=0;a<b.length;a++)this[this.length++]=b[a];return this}if(af.isObject(b)&&af.isObject(c)){if(b.length==p)b.parentNode==c&&(this[this.length++]=b);else for(a=0;a<b.length;a++)b[a].parentNode==c&&(this[this.length++]=b[a]);return this}if(af.isObject(b)&&c==p)return this[this.length++]=b,this;if(c!==p){if(c instanceof v)return c.find(b)}else c=
t}else return this;return this.selector(b,c)},m=function(b,c){return new v(b,c)};m.is$=function(b){return b instanceof v};m.map=function(b,c){var a,d=[],h;if(m.isArray(b))for(h=0;h<b.length;h++)a=c.apply(b[h],[h,b[h]]),a!==p&&d.push(a);else if(m.isObject(b))for(h in b)b.hasOwnProperty(h)&&"length"!=h&&(a=c(b[h],[h,b[h]]),a!==p&&d.push(a));return af(d)};m.each=function(b,c){var a;if(m.isArray(b))for(a=0;a<b.length&&!1!==c(a,b[a]);a++);else if(m.isObject(b))for(a in b)if(b.hasOwnProperty(a)&&"length"!=
a&&!1===c(a,b[a]))break;return b};m.extend=function(b){b==p&&(b=this);if(1===arguments.length){for(var c in b)this[c]=b[c];return this}I.call(arguments,1).forEach(function(c){for(var a in c)b[a]=c[a]});return b};m.isArray=function(b){return b instanceof Array&&b.push!=p};m.isFunction=function(b){return"function"===typeof b&&!(b instanceof RegExp)};m.isObject=function(b){return"object"===typeof b&&null!==b};m.fn=v.prototype={namepsace:"appframework",constructor:v,forEach:A.forEach,reduce:A.reduce,
push:A.push,indexOf:A.indexOf,concat:A.concat,selector:function(b,c){b=b.trim();if("#"===b[0]&&-1==b.indexOf(".")&&-1==b.indexOf(",")&&-1===b.indexOf(" ")&&-1===b.indexOf(">"))c==t?r(c.getElementById(b.replace("#","")),this):r(q(b,c),this);else if("<"===b[0]&&">"===b[b.length-1]||-1!==b.indexOf("<")&&-1!==b.indexOf(">")){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b.trim()}):a.innerHTML=b.trim();r(a.childNodes,this)}else r(q(b,c),this);return this},oldElement:void 0,
slice:A.slice,length:0,setupOld:function(b){if(b==p)return m();b.oldElement=this;return b},map:function(b){var c,a=[],d;for(d=0;d<this.length;d++)c=b.apply(this[d],[d,this[d]]),c!==p&&a.push(c);return m(a)},each:function(b){this.forEach(function(c,a){b.call(c,a,c)});return this},ready:function(b){"complete"===t.readyState||"loaded"===t.readyState||!m.os.ie&&"interactive"===t.readyState?b():t.addEventListener("DOMContentLoaded",b,!1);return this},find:function(b){if(0===this.length)return this;for(var c=
[],a,d=0;d<this.length;d++){a=m(b,this[d]);for(var h=0;h<a.length;h++)c.push(a[h])}return m(k(c))},html:function(b,c){if(0===this.length)return this;if(b===p)return this[0].innerHTML;for(var a=0;a<this.length;a++)if(!1!==c&&m.cleanUpContent(this[a],!1,!0),C){var d=this[a];MSApp.execUnsafeLocalFunction(function(){d.innerHTML=b})}else this[a].innerHTML=b;return this},text:function(b){if(0===this.length)return this;if(b===p)return this[0].textContent;for(var c=0;c<this.length;c++)this[c].textContent=
...
"none";else if("none"==this.css("display",null,this[a])&&(b==p||!0===c))this[a].style.display=this[a].getAttribute("afmOldStyle")?this[a].getAttribute("afmOldStyle"):"block",this[a].removeAttribute("afmOldStyle");return this},val:function(b){if(0===this.length)return b===p?void 0:this;if(b==p)return this[0].value;for(var c=0;c<this.length;c++)this[c].value=b;return this},attr:function(b,c){if(0===this.length)return c===p?void 0:this;if(c===p&&!m.isObject(b))return this[0].afmCacheId&&y[this[0].afmCacheId][b]?
this[0].afmCacheId&&y[this[0].afmCacheId][b]:this[0].getAttribute(b);for(var a=0;a<this.length;a++)if(m.isObject(b))for(var d in b)m(this[a]).attr(d,b[d]);else m.isArray(c)||m.isObject(c)||m.isFunction(c)?(this[a].afmCacheId||(this[a].afmCacheId=m.uuid()),y[this[a].afmCacheId]||(y[this[a].afmCacheId]={}),y[this[a].afmCacheId][b]=c):null===c?(this[a].removeAttribute(b),this[a].afmCacheId&&y[this[a].afmCacheId][b]&&delete y[this[a].afmCacheId][b]):this[a].setAttribute(b,c);return this},removeAttr:function(b){for(var c=
this,a=0;a<this.length;a++)b.split(/\s+/g).forEach(function(d){c[a].removeAttribute(d);c[a].afmCacheId&&y[c[a].afmCacheId][b]&&delete y[c[a].afmCacheId][b]});return this},prop:function(b,c){if(0===this.length)return c===p?void 0:this;if(c===p&&!m.isObject(b)){var a;return this[0].afmCacheId&&B[this[0].afmCacheId][b]?this[0].afmCacheId&&B[this[0].afmCacheId][b]:!(a=this[0][b])&&b in this[0]?this[0][b]:a}for(a=0;a<this.length;a++)if(m.isObject(b))for(var d in b)m(this[a]).prop(d,b[d]);else m.isArray(c)||
...
d.replace(l(b)," ")});d=d.trim();this[a].className=0<d.length?(d+" "+c).trim():c}return this},hasClass:function(b,c){if(0===this.length)return!1;c||(c=this[0]);return l(b).test(c.className)},append:function(b,a){if(b&&b.length!=p&&0===b.length)return this;if(m.isArray(b)||m.isObject(b))b=m(b);var d,h;for(d=0;d<this.length;d++)if(b.length&&"string"!=typeof b)b=m(b),n(b,this[d],a);else{var e=T.test(b)?m(b):void 0;if(e==p||0===e.length)e=t.createTextNode(b);if(e instanceof v)for(var f=0,s=e.length;f<
s;f++)h=e[f],h.nodeName!=p&&"script"==h.nodeName.toLowerCase()&&(!h.type||"text/javascript"===h.type.toLowerCase())?c.eval(h.innerHTML):n(m(h),this[d],a);else a!=p?this[d].insertBefore(e,this[d].firstChild):this[d].appendChild(e)}return this},appendTo:function(b,c){m(b).append(this);return this},prependTo:function(b){m(b).append(this,!0);return this},prepend:function(b){return this.append(b,1)},insertBefore:function(b,c){if(0===this.length)return this;b=m(b).get(0);if(!b)return this;for(var a=0;a<
this.length;a++)c?b.parentNode.insertBefore(this[a],b.nextSibling):b.parentNode.insertBefore(this[a],b);return this},insertAfter:function(b){this.insertBefore(b,!0)},get:function(b){b=b==p?0:b;0>b&&(b+=this.length);return this[b]?this[b]:void 0},offset:function(){var b;if(0===this.length)return this;if(this[0]==c)return{left:0,top:0,right:0,bottom:0,width:c.innerWidth,height:c.innerHeight};b=this[0].getBoundingClientRect();return{left:b.left+c.pageXOffset,top:b.top+c.pageYOffset,right:b.right+c.pageXOffset,
bottom:b.bottom+c.pageYOffset,width:b.right-b.left,height:b.bottom-b.top}},height:function(b){return 0===this.length?this:b!=p?this.css("height",b):this[0]==this[0].window?c.innerHeight:this[0].nodeType==this[0].DOCUMENT_NODE?this[0].documentElement.offsetHeight:(b=this.css("height").replace("px",""))?+b:this.offset().height},width:function(b){return 0===this.length?this:b!=p?this.css("width",b):this[0]==this[0].window?c.innerWidth:this[0].nodeType==this[0].DOCUMENT_NODE?this[0].documentElement.offsetWidth:
(b=this.css("width").replace("px",""))?+b:this.offset().width},parent:function(b,c){if(0===this.length)return this;for(var a=[],d=0;d<this.length;d++)for(var h=this[d];h.parentNode&&h.parentNode!=t&&!(a.push(h.parentNode),h.parentNode&&(h=h.parentNode),!c););return this.setupOld(m(k(a)).filter(b))},parents:function(b){return this.parent(b,!0)},children:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)c=c.concat(g(this[a].firstChild));return this.setupOld(m(c).filter(b))},
siblings:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)this[a].parentNode&&(c=c.concat(g(this[a].parentNode.firstChild,this[a])));return this.setupOld(m(c).filter(b))},contents:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)this[a].parentNode&&r(this[a].childNodes,c);return this.setupOld(m(c).filter(b))},closest:function(b,c){if(0===this.length)return this;var a=this[0],d=m(b,c);if(0===d.length)return m();for(;a&&-1==d.indexOf(a);)a=a!==
c&&a!==t&&a.parentNode;return m(a)},filter:function(b){if(0===this.length||b==p)return this;for(var c=[],a=0;a<this.length;a++){var d=this[a];d.parentNode&&0<=m(b,d.parentNode).indexOf(d)&&c.push(d)}return this.setupOld(m(k(c)))},not:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++){var d=this[a];d.parentNode&&-1==m(b,d.parentNode).indexOf(d)&&c.push(d)}return this.setupOld(m(k(c)))},data:function(b,c){var a;if(c)return this.attr("data-"+b,c);a=this.attr("data-"+b);try{a=
m.parseJSON(a)}catch(d){}return a},end:function(){return this.oldElement!=p?this.oldElement:m()},clone:function(b){b=!1===b?!1:!0;if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)c.push(this[a].cloneNode(b));return m(c)},size:function(){return this.length},serialize:function(){if(0===this.length)return"";for(var b=[],c=0;c<this.length;c++)this.slice.call(this[c].elements).forEach(function(c){var a=c.getAttribute("type");if("fieldset"!=c.nodeName.toLowerCase()&&(!c.disabled&&"submit"!=
a&&"reset"!=a&&"button"!=a&&("radio"!=a&&"checkbox"!=a||c.checked))&&c.getAttribute("name"))if("select-multiple"==c.type)for(a=0;a<c.options.length;a++)c.options[a].selected&&b.push(c.getAttribute("name")+"="+encodeURIComponent(c.options[a].value));else b.push(c.getAttribute("name")+"="+encodeURIComponent(c.value))});return b.join("&")},eq:function(b){return m(this.get(b))},index:function(b){return b?this.indexOf(m(b)[0]):this.parent().children().indexOf(this[0])},is:function(b){return!!b&&0<this.filter(b).length}};
m.ajaxSettings={type:"GET",beforeSend:a,success:a,error:a,complete:a,context:void 0,timeout:0,crossDomain:null};m.jsonP=function(b){if(C)return b.type="get",b.dataType=null,m.get(b);var a="jsonp_callback"+ ++S,d="",h,e=t.createElement("script");c[a]=function(h){clearTimeout(d);m(e).remove();delete c[a];b.success.call(void 0,h)};-1!==b.url.indexOf("callback=?")?e.src=b.url.replace(/=\?/,"="+a):(h=b.jsonp?b.jsonp:"callback",-1===b.url.indexOf("?")?b.url+="?"+h+"="+a:b.url+="&"+h+"="+a,e.src=b.url);
b.error&&(e.onerror=function(){clearTimeout(d);b.error.call(void 0,"","error")});m("head").append(e);0<b.timeout&&(d=setTimeout(function(){b.error.call(void 0,"","timeout")},b.timeout));return{}};m.ajax=function(b){var d;try{var h=b||{},e;for(e in m.ajaxSettings)"undefined"==typeof h[e]&&(h[e]=m.ajaxSettings[e]);h.url||(h.url=c.location);h.contentType||(h.contentType="application/x-www-form-urlencoded");h.headers||(h.headers={});if(!("async"in h)||!1!==h.async)h.async=!0;m.isObject(h.data)&&(h.data=
m.param(h.data));"get"===h.type.toLowerCase()&&h.data&&(-1===h.url.indexOf("?")?h.url+="?"+h.data:h.url+="&"+h.data);if(h.dataType)switch(h.dataType){case "script":h.dataType="text/javascript, application/javascript";break;case "json":h.dataType="application/json";break;case "xml":h.dataType="application/xml, text/xml";break;case "html":h.dataType="text/html";break;case "text":h.dataType="text/plain";break;case "jsonp":return m.jsonP(h);default:h.dataType="text/html"}else h.dataType="text/html";if(/=\?/.test(h.url))return m.jsonP(h);
null===h.crossDomain&&(h.crossDomain=/^([\w-]+:)?\/\/([^\/]+)/.test(h.url)&&RegExp.$2!=c.location.host);h.crossDomain||(h.headers=m.extend({"X-Requested-With":"XMLHttpRequest"},h.headers));var f,s=h.context,g=/^([\w-]+:)\/\//.test(h.url)?RegExp.$1:c.location.protocol;d=new c.XMLHttpRequest;d.onreadystatechange=function(){var b=h.dataType;if(4===d.readyState){clearTimeout(f);var c,a=!1;if(200<=d.status&&300>d.status||0===d.status&&"file:"==g){if("application/json"===b&&!/^\s*$/.test(d.responseText))try{c=
JSON.parse(d.responseText)}catch(e){a=e}else"application/xml, text/xml"===b?c=d.responseXML:"text/html"==b?(c=d.responseText,m.parseJS(c)):c=d.responseText;0===d.status&&0===c.length&&(a=!0);a?h.error.call(s,d,"parsererror",a):h.success.call(s,c,"success",d)}else a=!0,h.error.call(s,d,"error");h.complete.call(s,d,a?"error":"success")}};d.open(h.type,h.url,h.async);h.withCredentials&&(d.withCredentials=!0);h.contentType&&(h.headers["Content-Type"]=h.contentType);for(var q in h.headers)"string"===typeof h.headers[q]&&
d.setRequestHeader(q,h.headers[q]);if(!1===h.beforeSend.call(s,d,h))return d.abort(),!1;0<h.timeout&&(f=setTimeout(function(){d.onreadystatechange=a;d.abort();h.error.call(s,d,"timeout")},h.timeout));d.send(h.data)}catch(k){console.log(k),h.error.call(s,d,"error",k)}return d};m.get=function(b,c){return this.ajax({url:b,success:c})};m.post=function(b,c,a,d){"function"===typeof c&&(a=c,c={});d===p&&(d="html");return this.ajax({url:b,type:"POST",data:c,dataType:d,success:a})};m.getJSON=function(b,c,
a){"function"===typeof c&&(a=c,c={});return this.ajax({url:b,data:c,success:a,dataType:"json"})};m.param=function(b,c){var a=[];if(b instanceof v)b.each(function(){a.push((c?c+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});else for(var d in b)if(!m.isFunction(b[d])){var h=c?c+"["+d+"]":d,e=b[d];a.push(m.isObject(e)?m.param(e,h):h+"="+encodeURIComponent(e))}return a.join("&")};m.parseJSON=function(b){return JSON.parse(b)};m.parseXML=function(b){if(C)MSApp.execUnsafeLocalFunction(function(){return(new DOMParser).parseFromString(b,
...
c)};var x={},N=1;m.event={add:s,remove:F};m.fn.bind=function(b,c){for(var a=0,d=this.length;a<d;a++)s(this[a],b,c);return this};m.fn.unbind=function(b,c){for(var a=0,d=this.length;a<d;a++)F(this[a],b,c);return this};m.fn.one=function(b,c){return this.each(function(a,d){s(this,b,c,null,function(b,c){return function(){F(d,c,b);return b.apply(d,arguments)}})})};var Q=function(){return!0},R=function(){return!1},P={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",
stopPropagation:"isPropagationStopped"};m.fn.delegate=function(b,c,a,d){m.isFunction(a)&&(d=a,a=null);for(var h=0,e=this.length;h<e;h++)D(this[h],c,d,b,a);return this};m.fn.undelegate=function(b,c,a){for(var d=0,h=this.length;d<h;d++)F(this[d],c,a,b);return this};m.fn.on=function(b,c,a,d){m.isFunction(a)&&(d=a,a=null);return c===p||m.isFunction(c)?this.bind(b,c):this.delegate(c,b,a,d)};m.fn.off=function(b,c,a){return c===p||m.isFunction(c)?this.unbind(b,c):this.undelegate(c,b,a)};m.fn.trigger=function(b,
c,a){"string"==typeof b&&(b=m.Event(b,a));b.data=c;c=0;for(a=this.length;c<a;c++)this[c].dispatchEvent(b);return this};m.Event=function(b,c){var a=t.createEvent("Events"),d=!0;if(c)for(var h in c)"bubbles"==h?d=!!c[h]:a[h]=c[h];a.initEvent(b,d,!0,null,null,null,null,null,null,null,null,null,null,null,null);return a};m.bind=function(b,c,a){if(b){b.__events||(b.__events={});m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)b.__events[c[d]]||(b.__events[c[d]]=[]),b.__events[c[d]].push(a)}};m.trigger=
function(b,c,a){if(b){var d=!0;if(!b.__events)return d;m.isArray(c)||(c=[c]);m.isArray(a)||(a=[]);for(var h=0;h<c.length;h++)if(b.__events[c[h]])for(var e=b.__events[c[h]].slice(0),f=0;f<e.length;f++)m.isFunction(e[f])&&!1===e[f].apply(b,a)&&(d=!1);return d}};m.unbind=function(b,c,a){if(b.__events){m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)if(b.__events[c[d]])for(var h=b.__events[c[d]],e=0;e<h.length;e++)if(a==p&&delete h[e],h[e]==a){h.splice(e,1);break}}};m.proxy=function(b,c,a){return function(){return a?
b.apply(c,a):b.apply(c,arguments)}};var U=function(b,c){for(var a=0;a<b.length;a++)z(b[a],c)};m.cleanUpContent=function(b,c,a){if(b){var d=b.childNodes;d&&0<d.length&&m.asap(U,{},[I.apply(d,[0]),a]);c&&E(b,a)}};var H=[],K=[],L=[];m.asap=function(b,a,d){if(!m.isFunction(b))throw"$.asap - argument is not a valid function";H.push(b);K.push(a?a:{});L.push(d?d:[]);c.postMessage("afm-asap","*")};c.addEventListener("message",function(b){b.source==c&&"afm-asap"==b.data&&(b.stopPropagation(),0<H.length&&H.shift().apply(K.shift(),
L.shift()))},!0);var M={};m.parseJS=function(b){if(b){if("string"==typeof b){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b}):a.innerHTML=b;b=a}var d=b.getElementsByTagName("script");b=null;for(var h=0;h<d.length;h++)if(0<d[h].src.length&&!M[d[h].src]&&!C){var e=t.createElement("script");e.type=d[h].type;e.src=d[h].src;t.getElementsByTagName("head")[0].appendChild(e);M[d[h].src]=1;e=null}else c.eval(d[h].innerHTML)}};"click keydown keyup keypress submit load resize change select error".split(" ").forEach(function(b){m.fn[b]=
function(c){return c?this.bind(b,c):this.trigger(b)}});["focus","blur"].forEach(function(b){m.fn[b]=function(c){if(0!==this.length){if(c)this.bind(b,c);else for(c=0;c<this.length;c++)try{this[c][b]()}catch(a){}return this}}});return m}(window);window.jq=af;"$"in window||(window.$=af);"function"===typeof define&&define.amd?define("appframework",[],function(){return af}):"undefined"!==typeof module&&module.exports&&(module.exports.af=af,module.exports.$=af);window.numOnly||(window.numOnly=function(c){if(void 0===
c||""===c)return 0;if(isNaN(parseFloat(c)))if(c.replace)c=c.replace(/[^0-9.-]/g,"");else return 0;return parseFloat(c)})};/*
 Intel
...
numOnly(this.hscrollBar.style.height),this.hscrollBar.style[c.feat.cssPrefix+"Transition"]="");this.lastScrollInfo=a;this.hasMoved=!1;0==this.elementInfo.maxTop&&0==this.elementInfo.maxLeft?(this.currentScrollingObject=null,this.scrollToTop(0)):this.scrollerMoveCSS(this.lastScrollInfo,0)}};d.prototype.getCSSMatrix=function(b){if(this.androidFormsMode){var a=parseInt(b.style.marginTop,10);b=parseInt(b.style.marginLeft,10);isNaN(a)&&(a=0);isNaN(b)&&(b=0);return{f:a,e:b}}return c.getCssMatrix(b)};d.prototype.saveEventInfo=
...
this.elementInfo.maxTop&&(this.lastScrollInfo.y=-1*this.elementInfo.maxTop));this.scrollerMoveCSS(this.lastScrollInfo,0);this.setVScrollBar(this.lastScrollInfo,0,0);this.setHScrollBar(this.lastScrollInfo,0,0);this.refresh&&!this.preventPullToRefresh&&(!this.refreshTriggered&&this.lastScrollInfo.top>this.refreshHeight?(this.refreshTriggered=!0,this.setRefreshContent("Release to Refresh"),c.trigger(this,"refresh-trigger")):this.refreshTriggered&&this.lastScrollInfo.top<this.refreshHeight&&(this.refreshTriggered=
!1,this.setRefreshContent("Pull to Refresh"),c.trigger(this,"refresh-cancel")));this.infinite&&!this.infiniteTriggered&&Math.abs(this.lastScrollInfo.top)>this.el.clientHeight-this.container.clientHeight&&(this.infiniteTriggered=!0,c.trigger(this,"infinite-scroll"))}};d.prototype.calculateMovement=function(b,a){var c={top:0,left:0,speedY:0,speedX:0,absSpeedY:0,absSpeedX:0,deltaY:0,deltaX:0,absDeltaY:0,absDeltaX:0,y:0,x:0,duration:0},d=a?this.firstEventInfo:this.lastEventInfo,e=a?b.pageX:b.touches[0].pageX,
f=a?b.pageY:b.touches[0].pageY,g=a?b.time:b.timeStamp;c.deltaY=this.elementInfo.hasVertScroll?f-d.pageY:0;c.deltaX=this.elementInfo.hasHorScroll?e-d.pageX:0;c.time=g;c.duration=g-d.time;return c};d.prototype.calculateTarget=function(b){b.y=this.lastScrollInfo.y+b.deltaY;b.x=this.lastScrollInfo.x+b.deltaX};d.prototype.checkYboundary=function(b){var a=this.container.clientHeight/2,c=this.elementInfo.maxTop+a;if(b.y>a)b.y=a;else if(-b.y>c)b.y=-c;else return;this.recalculateDeltaY(b)};d.prototype.checkXboundary=
function(b){var a=this.container.clientWidth/2,c=this.elementInfo.maxLeft+a;if(b.x>a)b.x=a;else if(-b.x>c)b.x=-c;else return;this.recalculateDeltaX(b)};d.prototype.recalculateDeltaY=function(b){var a=Math.abs(b.deltaY);b.deltaY=b.y-b.top;newAbsDeltaY=Math.abs(b.deltaY);b.duration=b.duration*newAbsDeltaY/a};d.prototype.recalculateDeltaX=function(b){var a=Math.abs(b.deltaX);b.deltaX=b.x-b.left;newAbsDeltaX=Math.abs(b.deltaX);b.duration=b.duration*newAbsDeltaX/a};d.prototype.hideRefresh=function(b){if(!this.preventHideRefresh){var a=
this,d=function(){a.setRefreshContent("Pull to Refresh");c.trigger(a,"refresh-finish")};this.scrollerMoveCSS({x:0,y:0},325);!1===b||!a.afEl.css3Animate?d():a.afEl.css3Animate({time:"325ms",complete:d});this.refreshTriggered=!1}};d.prototype.setMomentum=function(b){b.speedY=this.divide(b.deltaY,b.duration);b.speedX=this.divide(b.deltaX,b.duration);b.absSpeedY=Math.abs(b.speedY);b.absSpeedX=Math.abs(b.speedX);b.absDeltaY=Math.abs(b.deltaY);b.absDeltaX=Math.abs(b.deltaX);if(0<b.absDeltaY){if(b.deltaY=
(0>b.deltaY?-1:1)*b.absSpeedY*b.absSpeedY/0.0024,b.absDeltaY=Math.abs(b.deltaY),b.duration=b.absSpeedY/0.0012,b.speedY=b.deltaY/b.duration,b.absSpeedY=Math.abs(b.speedY),0.12>b.absSpeedY||5>b.absDeltaY)b.deltaY=b.absDeltaY=b.duration=b.speedY=b.absSpeedY=0}else if(b.absDeltaX){if(b.deltaX=(0>b.deltaX?-1:1)*b.absSpeedX*b.absSpeedX/0.0024,b.absDeltaX=Math.abs(b.deltaX),b.duration=b.absSpeedX/0.0012,b.speedX=b.deltaX/b.duration,b.absSpeedX=Math.abs(b.speedX),0.12>b.absSpeedX||5>b.absDeltaX)b.deltaX=
b.absDeltaX=b.duration=b.speedX=b.absSpeedX=0}else b.duration=0};d.prototype.onTouchEnd=function(b){if(null!==this.currentScrollingObject&&this.moved){this.finishScrollingObject=this.currentScrollingObject;this.currentScrollingObject=null;b=this.calculateMovement(this.lastEventInfo,!0);this.androidFormsMode||this.setMomentum(b);this.calculateTarget(b);var a=this.getCSSMatrix(this.el);b.top=numOnly(a.f);b.left=numOnly(a.e);this.checkYboundary(b);this.elementInfo.hasHorScroll&&this.checkXboundary(b);
a=!this.preventPullToRefresh&&(b.top>this.refreshHeight||b.y>this.refreshHeight);this.fireRefreshRelease(a,0<b.top);if(this.refresh&&a)b.y=this.refreshHeight,b.duration=325;else if(0<=b.y)b.y=0,0<=b.top&&(b.duration=325);else if(-b.y>this.elementInfo.maxTop||0===this.elementInfo.maxTop)b.y=-this.elementInfo.maxTop,-b.top>this.elementInfo.maxTop&&(b.duration=325);if(this.elementInfo.hasHorScroll)if(0<=b.x)b.x=0,0<=b.left&&(b.duration=325);else if(-b.x>this.elementInfo.maxLeft||0===this.elementInfo.maxLeft)b.x=
-this.elementInfo.maxLeft,-b.left>this.elementInfo.maxLeft&&(b.duration=325);this.androidFormsMode&&(b.duration=0);this.scrollerMoveCSS(b,b.duration,"cubic-bezier(0.33,0.66,0.66,1)");this.setVScrollBar(b,b.duration,"cubic-bezier(0.33,0.66,0.66,1)");this.setHScrollBar(b,b.duration,"cubic-bezier(0.33,0.66,0.66,1)");this.setFinishCalback(b.duration);this.infinite&&!this.infiniteTriggered&&Math.abs(b.y)>=this.el.clientHeight-this.container.clientHeight&&(this.infiniteTriggered=!0,c.trigger(this,"infinite-scroll"))}};
...
"BackfaceVisibility"]="hidden")}};d.prototype.scrollerMoveCSS=function(b,d,e){d||(d=0);e||(e="linear");d=numOnly(d);this.el&&this.el.style&&(this.eventsActive&&(this.androidFormsMode?(this.el.style.marginTop=Math.round(b.y)+"px",this.el.style.marginLeft=Math.round(b.x)+"px"):(this.el.style[c.feat.cssPrefix+"Transform"]="translate"+r+b.x+"px,"+b.y+"px"+a,this.el.style[c.feat.cssPrefix+"TransitionDuration"]=d+"ms",this.el.style[c.feat.cssPrefix+"TransitionTimingFunction"]=e)),this.logPos(b.x,b.y))};
d.prototype.logPos=function(b,a){var c;c=this.elementInfo?{h:this.elementInfo.bottomMargin,w:this.elementInfo.rightMargin}:this.getViewportSize();this.loggedPcentX=this.divide(b,this.el.clientWidth-c.w);this.loggedPcentY=this.divide(a,this.el.clientHeight-c.h);this.scrollTop=a;this.scrollLeft=b};d.prototype.scrollbarMoveCSS=function(b,d,e,f){e||(e=0);f||(f="linear");b&&b.style&&(this.androidFormsMode?(b.style.marginTop=Math.round(d.y)+"px",b.style.marginLeft=Math.round(d.x)+"px"):(b.style[c.feat.cssPrefix+
"Transform"]="translate"+r+d.x+"px,"+d.y+"px"+a,b.style[c.feat.cssPrefix+"TransitionDuration"]=e+"ms",b.style[c.feat.cssPrefix+"TransitionTimingFunction"]=f))};d.prototype.scrollTo=function(b,a){a||(a=0);this.scrollerMoveCSS(b,a)};d.prototype.scrollBy=function(b,a){var c=this.getCSSMatrix(this.el),d=numOnly(c.f),c=numOnly(c.e);this.scrollTo({y:d-b.y,x:c-b.x},a)};d.prototype.scrollToBottom=function(b){this.scrollTo({y:-1*(this.el.clientHeight-this.container.clientHeight),x:0},b)};d.prototype.scrollToTop=
function(b){this.scrollTo({x:0,y:0},b)};return function(b,a){var g;if(!k&&c.touchLayer&&c.isObject(c.touchLayer))n();else if(!c.touchLayer||!c.isObject(c.touchLayer))c.touchLayer={};if(g="string"==typeof b||b instanceof String?document.getElementById(b):b)return af.os.desktop?new e(g,a):a.useJsScroll?new d(g,a):new f(g,a);alert("Could not find element for scroller "+b)}}()})(af);
...
(function(c){c.touchLayer=function(a){c.touchLayer=new f(a);return c.touchLayer};var n=["input","select","textarea"],l=["button","radio","checkbox","range","date"],k=c.os.ios,g=c.os.blackberry,q=c.os.blackberry||c.os.fennec||c.os.android&&!c.os.chrome,r=c.os.ios&&!c.os.ios7,a=!1,d=!1,f=function(a){this.clearTouchVars();a.addEventListener("touchstart",this,!1);a.addEventListener("touchmove",this,!1);a.addEventListener("touchend",this,!1);a.addEventListener("click",this,!1);a.addEventListener("focusin",
this,!1);document.addEventListener("scroll",this,!1);window.addEventListener("resize",this,!1);window.addEventListener("orientationchange",this,!1);this.layer=a;this.scrollEndedProxy_=c.proxy(this.scrollEnded,this);this.exitEditProxy_=c.proxy(this.exitExit,this,[]);this.launchFixUIProxy_=c.proxy(this.launchFixUI,this);var b=this;this.scrollTimeoutExpireProxy_=function(){b.scrollTimeout_=null;b.scrollTimeoutEl_.addEventListener("scroll",b.scrollEndedProxy_,!1)};this.retestAndFixUIProxy_=function(){af.os.android&&
...
backButtonText:"",resetScrollers:!0,ready:function(a){if(this.launchCompleted)a();else c(document).on("afui:ready",function(c){a()})},setBackButtonStyle:function(a){c.query("#header #backButton").get(0).className=a},goBack:function(a){if(a=Math.min(Math.abs(~~a||1),this.history.length))a=this.history.splice(-a).shift(),this.loadContent(a.target+"",0,1,a.transition),this.transitionType=a.transition,this.updateHash(a.target)},clearHistory:function(){this.history=[];this.setBackButtonVisibility(!1)},
pushHistory:function(a,d,f,e){this.history.push({target:a,transition:f});try{this.manageHistory&&(window.history.pushState(d,d,n+"#"+d+e),c(window).trigger("hashchange",null,{newUrl:n+"#"+d+e,oldURL:n+a}))}catch(b){}},updateHash:function(a){if(this.manageHistory){k=a=-1==a.indexOf("#")?"#"+a:a;var d=window.location.hash,f=this.getPanelId(a).substring(1);try{window.history.replaceState(f,f,n+a),c(window).trigger("hashchange",null,{newUrl:n+a,oldUrl:n+d})}catch(e){}}},getPanelId:function(a){var c=a.indexOf("/");
return-1==c?a:a.substring(0,c)},updateBadge:function(a,d,f,e){void 0===f&&(f="");a=c(a);var b=a.find("span.af-badge");0===b.length?("absolute"!=a.css("position")&&a.css("position","relative"),b=c.create("span",{className:"af-badge "+f,html:d}),a.append(b)):b.html(d);b.removeClass("tl bl br tr");b.addClass(f);void 0===e&&(e="red");c.isObject(e)?b.css(e):e&&b.css("background",e);b.data("ignore-pressed","true")},removeBadge:function(a){c(a).find("span.af-badge").remove()},toggleNavMenu:function(a){if(this.showNavMenu)if("none"!=
...
c.query("#content").css("top",c.query("#header").css("height"))},toggleSideMenu:function(a,d,f){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){var e=this,b=c.query("#menu"),h=c.query("#content,  #header, #navbar"),g=c.query(".afui_panel_mask");f=f||this.transitionTime;var k=this.isSideMenuOn();0===g.length&&window.innerWidth<c.ui.handheldMinWidth&&(h.append('<div class="afui_panel_mask"></div>'),g=c.query(".afui_panel_mask"),c(".afui_panel_mask").bind("click",function(){c.ui.toggleSideMenu(!1)}));
if(2===a||!k&&(void 0!==a&&!1!==a||void 0===a))this.togglingSideMenu=!0,b.show(),e.css3animate(h,{x:e.sideMenuWidth,time:f,complete:function(a){e.togglingSideMenu=!1;h.vendorCss("Transition","");d&&d(a);0!==g.length&&window.innerWidth<c.ui.handheldMinWidth&&g.show()}});else if(void 0===a||void 0!==a&&!1===a)this.togglingSideMenu=!0,e.css3animate(h,{x:"0px",time:f,complete:function(a){h.vendorCss("Transition","");h.vendorCss("Transform","");e.togglingSideMenu=!1;d&&d(a);b.hide();0!==g.length&&window.innerWidth<
c.ui.handheldMinWidth&&g.hide()}})}},disableSideMenu:function(){var a=c.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(c){c||a.removeClass("hasMenu")}):a.removeClass("hasMenu");c.query("#menu").removeClass("tabletMenu")},enableSideMenu:function(){c.query("#content, #header, #navbar").addClass("hasMenu");c.query("#menu").addClass("tabletMenu")},isSideMenuEnabled:function(){return c.query("#content").hasClass("hasMenu")},isSideMenuOn:function(){var a=1<parseInt(c.getCssMatrix(c("#content")).e)?
!0:!1;return this.isSideMenuEnabled()&&a},prevFooter:null,updateNavbarElements:function(a){this.prevFooter&&(this.prevFooter.data("parent")?this.prevFooter.appendTo("#"+this.prevFooter.data("parent")):this.prevFooter.appendTo("#afui"));c.is$(a)||(a=c.query("#"+a));c.query("#navbar").append(a);this.prevFooter=a;a=c.query("#navbar a");if(0<a.length){a.data("ignore-pressed","true").data("resetHistory","true");var d=parseFloat(100/a.length);a.css("width",d+"%")}a=c.query("#navbar footer");if(0!==a.length){a=
a.get(0).childNodes;for(d=0;d<a.length;d++)3===a[d].nodeType&&a[d].parentNode.removeChild(a[d])}},prevHeader:null,updateHeaderElements:function(a,d){var f=this;c.is$(a)||(a=c.query("#"+a));if(a!=this.prevHeader)if(this._currentHeaderID=a.prop("id"),this.prevHeader)if(c.query("#header").append(a),c.ui.animateHeaders){var e=d?"100px":"-100px",b=d?"-100px":"100px";f.prevHeader.addClass("ignore");f.css3animate(a,{x:b,opacity:0.3,time:"1ms"});f.css3animate(f.prevHeader,{x:e,y:0,opacity:0.3,time:f.transitionTime,
delay:numOnly(f.transitionTime)/5+"ms",complete:function(){f.prevHeader.data("parent")?f.prevHeader.appendTo("#"+f.prevHeader.data("parent")):f.prevHeader.appendTo("#afui");f.prevHeader.removeClass("ignore");f.css3animate(f.prevHeader,{x:b,opacity:1,time:"1ms"});f.prevHeader=a}});f.css3animate(a,{x:"0px",opacity:1,time:f.transitionTime})}else f.prevHeader.data("parent")?f.prevHeader.appendTo("#"+f.prevHeader.data("parent")):f.prevHeader.appendTo("#afui"),f.prevHeader=a;else c.query("#header").append(a),
this.prevHeader=a},updateSideMenu:function(a){return this.updateSideMenuElements(a)},updateSideMenuElements:function(a){if(!(void 0===a||null===a)){var d=c.query("#menu_scroller");this.prevMenu&&(this.prevMenu.insertBefore("#afui #menu"),this.prevMenu=null);c.is$(a)||(a=c.query("#"+a));d.html("");d.append(a);this.prevMenu=a;this.scrollingDivs.menu_scroller.hideScrollbars();this.scrollingDivs.menu_scroller.scrollToTop()}},setTitle:function(a){"defaultHeader"===this._currentHeaderID&&c.query("#header header:not(.ignore)  #pageTitle").html(a)},
setBackButtonText:function(a){"defaultHeader"===this._currentHeaderID&&(this.trimBackButtonText&&7<=a.length&&(a=a.substring(0,5)+"..."),0<this.backButtonText.length?c.query("#header header:not(.ignore) #backButton").html(this.backButtonText):c.query("#header header:not(.ignore)  #backButton").html(a))},setBackButtonVisibility:function(a){a?c.query("#header #backButton").css("visibility","visible"):c.query("#header #backButton").css("visibility","hidden")},showMask:function(a){a||(a=this.loadingText||
"");c.query("#afui_mask>h1").html(a);c.query("#afui_mask").show()},hideMask:function(){c.query("#afui_mask").hide()},modalReference_:null,showModal:function(a,d){this.modalTransition=d||"up";var f=c.query("#modalContainer");"string"===typeof a&&(a="#"+a.replace("#",""));var e=c.query(a);this.modalReference_=e;if(e.length){var b=this.scrollingDivs.hasOwnProperty(e.attr("id")),b=this.scrollingDivs.hasOwnProperty(e.attr("id"));f.empty();var h;h=c.feat.nativeTouchScroll||!b?e.contents():c(e.get(0).childNodes[0]).contents();
f.append(h);f.append("<a onclick='$.ui.hideModal();' class='closebutton modalbutton'></a>");this.modalWindow.style.display="block";this.runTransition(this.modalTransition,this.modalTransContainer,this.modalWindow,!1);b?this.scrollingDivs.modal_container.enable(this.resetScrollers):this.scrollingDivs.modal_container.disable();this.scrollToTop("modal");f.data("panel",a);f=e.get(0);b=f.getAttribute("data-load");if("string"==typeof b&&window[b])window[b](f);e.trigger("loadpanel")}},hideModal:function(){var a=
this,d=c.query("#modalContainer");d.find(".closebutton.modalbutton").remove();var f=this.scrollingDivs.hasOwnProperty(this.modalReference_.attr("id"));this.runTransition(a.modalTransition,a.modalWindow,a.modalTransContainer,!0);this.scrollingDivs.modal_container.disable();var e=c.query(d.data("panel")),b=e.data("unload");if("string"==typeof b&&window[b])window[b](e.get(0));e.trigger("unloadpanel");setTimeout(function(){c.feat.nativeTouchScroll||!f?a.modalReference_.append(d.contents()):c(a.modalReference_.get(0).childNodes[0]).append(d.contents());
d.html("",!0)},this.transitionTime)},updatePanel:function(a,d){a="#"+a.replace("#","");var f=c.query(a).get(0);if(f){var e=c.create("div",{html:d}),e=e.children(".panel")&&0<e.children(".panel").length?e.children(".panel").get(0):e.get(0);f.getAttribute("js-scrolling")&&("yes"==f.getAttribute("js-scrolling").toLowerCase()||"true"==f.getAttribute("js-scrolling").toLowerCase())?(c.cleanUpContent(f.childNodes[0],!1,!0),c(f.childNodes[0]).html(d)):(c.cleanUpContent(f,!1,!0),c(f).html(d));e.getAttribute("data-title")&&
f.setAttribute("data-title",e.getAttribute("data-title"))}},updateContentDiv:function(a,c){return this.updatePanel(a,c)},addContentDiv:function(a,d,f,e,b){a="string"!==typeof a?a:-1==a.indexOf("#")?"#"+a:a;var h=c.query(a).get(0);h?d=h:(d=c.create("div",{html:d}),d=d.children(".panel")&&0<d.children(".panel").length?d.children(".panel").get(0):d.get(0),!d.getAttribute("data-title")&&f&&d.setAttribute("data-title",f),f=d.id?d.id:a.replace("#",""),d.id=f,d.id!=a&&d.setAttribute("data-crc",a.replace("#",
"")));d.className="panel";f=d.id;this.addDivAndScroll(d,e,b);return f},addDivAndScroll:function(a,d,f,e){var b=!1,h,g=a.style.overflow,g="hidden"!=g&&"visible"!=g;e=e||this.content;!c.feat.nativeTouchScroll&&g&&a.setAttribute("js-scrolling","true");if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||"true"==a.getAttribute("js-scrolling").toLowerCase()))g=b=!0;h=a.getAttribute("data-title")||a.title;a.title="";a.setAttribute("data-title",h);a.getAttribute("scrolling")&&
"no"==a.getAttribute("scrolling")&&(b=g=!1,a.removeAttribute("js-scrolling"));if(!b||c.os.desktop)e.appendChild(a),h=a,a.style["-webkit-overflow-scrolling"]="none";else{h=a.cloneNode(!1);a.title=null;a.id=null;var k=c(a);k.removeAttr("data-footer data-aside data-nav data-header selected data-load data-unload data-tab data-crc title data-title");k.replaceClass("panel","afScrollPanel");h.appendChild(a);e.appendChild(h);!1!==this.selectBox&&this.selectBox.getOldSelects(h.id);!1!==this.passwordBox&&this.passwordBox.getOldPasswords(h.id)}g&&
(this.scrollingDivs[h.id]=c(a).scroller({scrollBars:!0,verticalScroll:!0,horizontalScroll:this.horizontalScroll,vScrollCSS:"afScrollbar",refresh:d,useJsScroll:b,noParent:!b,lockBounce:this.lockPageBounce,autoEnable:!1}),f&&c.bind(this.scrollingDivs[h.id],"refresh-release",function(a){a&&f()}));h=a=null},scrollToTop:function(a,c){c=c||"300ms";a=a.replace("#","");this.scrollingDivs[a]&&this.scrollingDivs[a].scrollToTop(c)},scrollToBottom:function(a,c){a=a.replace("#","");this.scrollingDivs[a]&&this.scrollingDivs[a].scrollToBottom(c)},
parsePanelFunctions:function(a,d,f){var e=this,b=a.getAttribute("data-footer"),h=a.getAttribute("data-header");b&&"none"==b.toLowerCase()?(e.toggleNavMenu(!1),b=!1):e.toggleNavMenu(!0);b&&e.customFooter!=b?(e.customFooter=b,e.updateNavbarElements(b)):b!=e.customFooter&&(e.customFooter&&e.updateNavbarElements(e.defaultFooter),e.customFooter=!1);h&&"none"==h.toLowerCase()?(e.toggleHeaderMenu(!1),h=!1):e.toggleHeaderMenu(!0);h&&e.customHeader!=h?(e.customHeader=h,e.updateHeaderElements(h,f)):h!=e.customHeader&&
(e.customHeader&&e.updateHeaderElements(e.defaultHeader,f),e.customHeader=!1);b=c(a).find("footer");0<b.length&&(e.customFooter=a.id,b.data("parent",a.id),e.updateNavbarElements(b));b=c(a).find("header");0<b.length&&(e.customHeader=a.id,b.data("parent",a.id),e.updateHeaderElements(b,f));a.getAttribute("data-tab")&&(c.query("#navbar a").removeClass("pressed"),c.query("#navbar #"+a.getAttribute("data-tab")).addClass("pressed"));(f=a.getAttribute("data-nav"))&&this.customMenu!=f?(this.customMenu=f,this.updateSideMenuElements(f)):
f!=this.customMenu&&(this.customMenu&&this.updateSideMenuElements(this.defaultMenu),this.customMenu=!1);if(d){f=d.getAttribute("data-unload");if("string"==typeof f&&window[f])window[f](d);c(d).trigger("unloadpanel")}f=a.getAttribute("data-load");if("string"==typeof f&&window[f])window[f](a);c(a).trigger("loadpanel");this.isSideMenuOn()&&this.toggleSideMenu(!1)},parseScriptTags:function(a){a&&c.parseJS(a)},loadContent:function(a,d,f,e,b){if(this.doingTransition)this.loadContentQueue.push([a,d,f,e,
b]);else if(0!==a.length){var h=!0;b=b||document.createElement("a");if(-1==a.indexOf("#")){var g="url"+r(a),k=c.query("div.panel[data-crc='"+g+"']");0<c.query("#"+a).length?h=!1:0<k.length?(h=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?h=!0:a="#"+k.get(0).id):0<c.query("#"+g).length&&(h=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?h=!0:a="#"+g)}-1==a.indexOf("#")&&h?this.loadAjax(a,d,f,e,b):this.loadDiv(a,
d,f,e)}},loadDiv:function(a,d,f,e){var b=this,h=a.replace("#",""),g=h.indexOf("/"),l="";-1!=g&&(l=h.substr(g),h=h.substr(0,g));if(h=c.query("#"+h).get(0))if(h==this.activeDiv&&!f)this.isSideMenuOn()&&this.toggleSideMenu(!1);else{this.transitionType=e;var n=this.activeDiv;a=h;if("true"==h.getAttribute("data-modal")||"true"==h.getAttribute("modal"))return this.showModal(h.id);n!=a&&(d?(this.clearHistory(),this.pushHistory("#"+this.firstDiv.id,h.id,e,l)):f||this.pushHistory(k,h.id,e,l),k="#"+h.id+l,
this.doingTransition=!0,n.style.display="block",a.style.display="block",this.runTransition(e,n,a,f),this.parsePanelFunctions(h,n,f),this.loadContentData(h,d,f,e),setTimeout(function(){b.scrollingDivs[n.id]&&b.scrollingDivs[n.id].disable()},numOnly(b.transitionTime)+50))}else c(document).trigger("missingpanel",null,{missingTarget:a})},loadContentData:function(a,d,f,e){f?0<this.history.length&&(f=this.history[this.history.length-1],e=f.target.indexOf("/"),f=-1!=e?f.target.substr(0,e):f.target,(f=c.query(f).get(0))?
this.setBackButtonText(f.getAttribute("data-title")):this.setBackButtonText("Back")):this.activeDiv.getAttribute("data-title")?this.setBackButtonText(this.activeDiv.getAttribute("data-title")):this.setBackButtonText("Back");a.getAttribute("data-title")&&this.setTitle(a.getAttribute("data-title"));d&&(this.setBackButtonText(this.firstDiv.getAttribute("data-title")),a==this.firstDiv&&(this.history.length=0));c("#header #menubadge").css("float","right");0===this.history.length?(this.setBackButtonVisibility(!1),
this.history=[],c("#header #menubadge").css("float","left")):this.showBackButton&&this.showBackbutton&&this.setBackButtonVisibility(!0);this.activeDiv=a;this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(this.resetScrollers)},loadAjax:function(a,d,f,e,b){if(!("afui_ajax"==this.activeDiv.id&&a==this.ajaxUrl)){var h="url"+r(a),g=this;-1==a.indexOf("http")&&(a=intel.xdk.webRoot+a);var k=new XMLHttpRequest;b&&"object"!==typeof b&&(b=document.createElement("a"),b.setAttribute("data-persist-ajax",
!0));b=b||document.createElement("a");k.onreadystatechange=function(){if(4==k.readyState&&200==k.status){this.doingTransition=!1;var l,n=!1;l=c.query("#"+h);if(0<l.length)g.updatePanel(h,k.responseText),l.get(0).setAttribute("data-title",b.title?b.title:a);else if(b.getAttribute("data-persist-ajax")||g.isAjaxApp){var q="true"===b.getAttribute("data-pull-scroller")?!0:!1;l=q?function(){b.refresh=!0;g.loadContent(a,d,f,e,b);b.refresh=!1}:null;var p=c(k.responseText);p.hasClass("panel")?(h=p.attr("id"),
p=p.get(0).innerHTML):p=p.html();0<c("#"+h).length?g.updatePanel("#"+h,p):0<c("div.panel[data-crc='"+h+"']").length?(g.updatePanel(c("div.panel[data-crc='"+h+"']").get(0).id,p),h=c("div.panel[data-crc='"+h+"']").get(0).id):h=g.addContentDiv(h,k.responseText,b.title?b.title:a,q,l)}else g.updatePanel("afui_ajax",k.responseText),c.query("#afui_ajax").get(0).setAttribute("data-title",b.title?b.title:a),g.loadContent("#afui_ajax",d,f,e),n=!0;l=document.createElement("div");c(l).html(k.responseText);g.parseScriptTags(l);
if(n)g.showLoading&&g.hideMask();else return g.loadContent("#"+h,d,f,e),g.showLoading&&g.hideMask(),null}};this.ajaxUrl=a;var l=this.useAjaxCacheBuster?a+(a.split("?")[1]?"&":"?")+"cache="+1E16*Math.random():a;k.open("GET",l,!0);k.setRequestHeader("X-Requested-With","XMLHttpRequest");k.send();this.showLoading&&this.showMask()}},runTransition:function(a,c,f,e){this.availableTransitions[a]||(a="default");this.availableTransitions[a].call(this,c,f,e)},launch:function(){if(!1===this.hasLaunched||this.launchCompleted)this.hasLaunched=
!0;else{var a=this;this.viewportContainer=af.query("#afui");this.navbar=af.query("#navbar").get(0);this.content=af.query("#content").get(0);this.header=af.query("#header").get(0);this.menu=af.query("#menu").get(0);this.viewportContainer.on("click","a",function(b){a.useInteralRouting&&q(b,b.currentTarget)});var d=null;c.bind(c.touchLayer,"enter-edit",function(a){d=a});c.bind(c.touchLayer,"enter-edit-reshape",function(){var b=c(d),e=b.closest(a.activeDiv);if(e&&0<e.size())if(c.os.ios||c.os.chrome){var f;
f=document.body.scrollTop?document.body.scrollTop-e.offset().top:0;b=e.offset().bottom-b.offset().bottom;a.scrollingDivs[a.activeDiv.id].setPaddings(f,b)}else if(c.os.android||c.os.blackberry)f=b.offset(),e=e.offset(),f.bottom>e.bottom&&f.height<e.height&&a.scrollingDivs[a.activeDiv.id].scrollToItem(b,"bottom")});c.os.ios&&c.bind(c.touchLayer,"exit-edit-reshape",function(){a.activeDiv&&(a.activeDiv.id&&a.scrollingDivs.hasOwnProperty(a.activeDiv.id))&&a.scrollingDivs[a.activeDiv.id].setPaddings(0,
...
e[b],success:function(d){0<d.length&&(a.updatePanel(b,d),a.parseScriptTags(c.query("#"+b).get(0)));z++;z>=E&&(D=!1,c(document).trigger("defer:loaded"))},error:function(a){console.log("Error with deferred load "+intel.xdk.webRoot+e[b]);z++;z>=E&&(D=!1,c(document).trigger("defer:loaded"))}})})(p)}if(this.firstDiv)if(this.activeDiv=this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(),n=function(){c.query("#navbar").append(c.create("footer",{id:"defaultNav"}).append(c.query("#navbar").children()));
